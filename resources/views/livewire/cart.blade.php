<div class="mt-16">
    @if($this->items->isEmpty())
        <div class="flex flex-col items-center justify-center h-64 bg-white shadow-xl rounded-lg p-8 mx-10">
            <p class="text-xl font-semibold text-gray-800 mb-4">Your cart is empty</p>
            <p class="text-gray-600 mb-8">Browse our categories and discover our best deals!</p>
            <a href="{{ route('home') }}" class="px-6 py-3 bg-blue-600 text-white font-bold rounded-lg shadow hover:bg-blue-500">
                Start Shopping Now
            </a>
        </div>
    @else
